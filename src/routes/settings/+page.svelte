	...
	<div class="bg-dark-card border border-dark-border p-6 rounded-xl shadow-dark-card">
		...
		<div class="space-y-4">
			<button
				...
				class="py-2 px-4 bg-red-600 text-highlight font-medium rounded-lg hover:bg-red-700 transition focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50"
			>
				Clear All Data
			</button>
		</div>
