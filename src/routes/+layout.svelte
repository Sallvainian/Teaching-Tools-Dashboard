		...
		<aside class="hidden md:block w-48 lg:w-56 bg-dark-surface border-r border-dark-border p-4">
			<div class="space-y-6">
				<div>
					...
					<div class="space-y-1">
						<a href="/dashboard" class="flex items-center gap-2 px-3 py-2 rounded-lg text-gray-300 hover:bg-dark-accent hover:text-white">
						...
						<a href="/class-dojo-remake" class="flex items-center gap-2 px-3 py-2 rounded-lg text-gray-300 hover:bg-dark-accent hover:text-white">
							<svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
