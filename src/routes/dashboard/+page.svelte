...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
	<div class="bg-dark-card border border-dark-border p-4 rounded-xl">
		<div class="flex items-center justify-between">
			...
			<div class="w-10 h-10 rounded-lg bg-dark-purple bg-opacity-20 flex items-center justify-center text-dark-highlight">
		...
		{#each modules as mod}
			...
			>
				...
				<div class="mt-4 pt-4 border-t border-dark-border flex justify-between items-center">
					...
					<svg class="w-5 h-5 text-dark-lavender transform group-hover:translate-x-1 transition-transform" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
...
<div class="bg-dark-card border border-dark-border rounded-xl p-6 shadow-dark-card">
	...
	<div class="space-y-4">
		<div class="flex items-start gap-4">
			<div class="w-8 h-8 rounded-full bg-dark-purple bg-opacity-20 flex items-center justify-center text-dark-highlight flex-shrink-0">
				<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
					<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
				</svg>
			</div>
			<div>
				<p class="text-white">Added a new assignment: <span class="text-dark-highlight">Midterm Exam</span></p>
		...
		<div class="flex items-start gap-4">
			...
			<div>
				<p class="text-white">Added a new student: <span class="text-dark-highlight">Emily Johnson</span></p>
